...
from VManagePlatform.views import vBackup
...
urlpatterns = [
    ...
    url(r'^$',vComs.index),
    url(r'^allInstance/$',vServer.allInstance),
    url(r'^handleBackup/(?P<id>[0-9]+)/$',vBackup.handleBackup),
    ...
    url(r'^deleteLogs/',vProfile.delete_logs),
